    ...
    async getAllData() {
        try {
            const response = await new Promise((resolve, reject) => {
                ...
                const query4d = "SELECT email FROM enrollmentrefresh;"
                                        ...
                                        connection.query(query9, (err, results) => {
                                            ...
                                            connection.query(query10, (err, results) => {
                                                ...
                                                connection.query(query11, (err, results) => {
                                                    ...
                                                    resolve(results);
                                                    var emailArray = []
                                                    connection.query(query4d, (err, rows, results) => {
                                                        if(err) console.log(err.message);
                                                        console.log("Step 4d returned " + i + " records.");
                                                        for(i=0; i < results.length; i++){
                                                            if(rows[i] != undefined){
                                                                for(var i in rows){
                                                                    ...
                                                                    if(err) console.log(err.message);
                                                                    console.log("Inserting " + emailArray[i] + " into tb_enrollment_emails");
                                                                    })
                                                                }
                                                            }
                                                        }
